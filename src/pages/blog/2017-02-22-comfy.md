...
- 90% of the users want to create a personalized list of talks and booths to attend during the conference.

*"The ideal app should provide information up to date. It needs to be trustful".* - User research

### B) "Poor networking."

- 80% of the interviewed want to meet people (including attendees and speakers) during the event.
- 78% desire to achieve it from an app.
- 83% of the users want to make contact with companies and to increase their professional networking.
